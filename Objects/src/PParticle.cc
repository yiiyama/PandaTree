...
panda::PParticle::PParticle() :
  ContainerElement(utils::Allocator<PParticle>()),
...
panda::PParticle::PParticle(utils::AllocatorBase const& _allocator) :
...
void
panda::PParticle::setStatus(TTree& _tree, TString const& _name, Bool_t _status, utils::BranchList const& _branches/* = {"*"}*/)
{
...
void
panda::PParticle::setAddress(TTree& _tree, TString const& _name, utils::BranchList const& _branches/* = {"*"}*/)
{
...
void
panda::PParticle::book(TTree& _tree, TString const& _name, utils::BranchList const& _branches/* = {"*"}*/)
{
