...
panda::GenReweight::getListOfBranches()
{
  ...
  blist += {"r1f2DW", "r1f5DW", "r2f1DW", "r2f2DW", "r5f1DW", "r5f5DW", "nnpdfAltDW", "genParam"};
  return blist;
}
  ...
  r5f5DW(_src.r5f5DW)
{
  ...
  r5f1DW = _src.r5f1DW;
  r5f5DW = _src.r5f5DW;
  std::memcpy(nnpdfAltDW, _src.nnpdfAltDW, sizeof(Float_t) * 100);
...
panda::GenReweight::doSetStatus_(TTree& _tree, utils::BranchList const& _branches)
{
  ...
  utils::setStatus(_tree, name_, "nnpdfAltDW", _branches);
...
panda::GenReweight::doGetStatus_(TTree& _tree) const
{
  ...
  blist.push_back(utils::getStatus(_tree, name_, "nnpdfAltDW"));
...
panda::GenReweight::doSetAddress_(TTree& _tree, utils::BranchList const& _branches/* = {"*"}*/, Bool_t _setStatus/* = kTRUE*/)
{
  ...
  utils::setAddress(_tree, name_, "nnpdfAltDW", nnpdfAltDW, _branches, _setStatus);
...
panda::GenReweight::doBook_(TTree& _tree, utils::BranchList const& _branches/* = {"*"}*/)
{
  ...
  utils::book(_tree, name_, "nnpdfAltDW", TString::Format("[100]"), 'F', nnpdfAltDW, _branches);
...
panda::GenReweight::dump(std::ostream& _out/* = std::cout*/) const
{
  ...
  _out << "nnpdfAltDW = " << nnpdfAltDW << std::endl;
