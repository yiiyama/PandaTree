...
panda::Jet::getListOfBranches()
{
  ...
  blist += {"rawPt", "ptCorrUp", "ptCorrDown", "ptSmear", "ptSmearUp", "ptSmearDown", "area", "nhf", "chf", "cef", "nef", "puid", "loose", "tight", "tightLepVeto", "monojet", "matchedGenJet_", "constituents_", "secondaryVertex_"};
  return blist;
}
