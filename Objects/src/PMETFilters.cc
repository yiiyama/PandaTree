...
void
panda::PMETFilters::setAddress(TTree& _tree, utils::BranchList const& _branches/* = {"*"}*/)
{
  Singlet::setAddress(_tree, _branches);

  utils::setStatusAndAddress(_tree, name_, "cschalo", &cschalo, _branches);
  utils::setStatusAndAddress(_tree, name_, "globalHalo16", &globalHalo16, _branches);
  utils::setStatusAndAddress(_tree, name_, "hbhe", &hbhe, _branches);
  utils::setStatusAndAddress(_tree, name_, "hbheIso", &hbheIso, _branches);
  utils::setStatusAndAddress(_tree, name_, "badsc", &badsc, _branches);
  utils::setStatusAndAddress(_tree, name_, "badTrack", &badTrack, _branches);
  utils::setStatusAndAddress(_tree, name_, "badMuonTrack", &badMuonTrack, _branches);
}
