...
template <>
struct plotter <7> {
  constexpr static const char* name = "common/pfMetSignificance";
  std::vector<float> operator () (panda::Event& event) {
    std::vector<float> output {float(event.pfMetSignificance)};
    return output;
  }
};
...
template <>
struct plotter <68> {
  constexpr static const char* name = "tracks/loose";
  std::vector<float> operator () (panda::Event& event) {
...
template <>
struct plotter <70> {
  constexpr static const char* name = "tracks/tight";
  std::vector<float> operator () (panda::Event& event) {
